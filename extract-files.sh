...
sed -i 's|/system/framework/QtiTelephonyServicelibrary.jar|/vendor/framework/QtiTelephonyServicelibrary.jar|g' "${COMMON_BLOB_ROOT}/vendor/etc/permissions/telephonyservice.xml"
